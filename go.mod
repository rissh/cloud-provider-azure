...
// CVE-2026-33186: OpenShift sustaining backport for Go 1.19 (upstream v1.79.3 requires Go 1.24).
...
// Pin OpenTelemetry modules to prevent transitive dependency cascade from the
// grpc-go fork (via cloud.google.com/go) upgrading otel beyond v1.10.0, which
// removes internal packages required by the k8s apiserver otel exporter stack.
replace (
